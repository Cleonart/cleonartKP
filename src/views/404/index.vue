<template>
	<div style="position: absolute;top: 50%;transform: translate(-50%, -50%);left: 50%;">
		<div class="flex justify-center mb-5 -mt-12">
			<svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11" viewBox="0 0 215.000000 215.000000" preserveAspectRatio="xMidYMid meet">
