<template>
  ...
  <div class="container px-10 mb-10 pt-10 mx-auto">
    <div class="flex">
      ...
      <div class="ml-4">
        <h1 class="text-3xl text-left font-medium title-font text-gray-800 mb-1">Produk-Produk Unggulan</h1>
        <p class="text-gray-600 mb-7">Lihat produk-produk unggulan HDI dibawah ini</p>
      </div>
    </div>
